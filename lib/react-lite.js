...
(function (global, factory) {
  ...
  function applyUpdate(data) {
      ...
      if (currentNode !== newNode) {
          // modify by jiyanliang @20160603 for ie8
          // newNode.parentNode.insertBefore(newNode, currentNode);
          newNode.parentNode.insertBefore(newNode, (typeof currentNode != 'undefined') ? currentNode : null);
      }
      return newNode;
  }
  ...
  function applyCreate(data) {
      ...
      data.parentNode.insertBefore(node, ((typeof data.parentNode.childNodes[data.index] != 'undefined'))
                            ? data.parentNode.childNodes[data.index]
                            : null);
  }
